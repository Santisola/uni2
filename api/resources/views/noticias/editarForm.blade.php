...
@section('main')
    <div class="container">
        <h1 class="text-center text-3xl mb-10 texto-violeta font-bold">Editar noticia</h1>
        <form action="{{ route('noticias.editar', ['noticia' => $noticia->id_noticia]) }}" method="post" enctype="multipart/form-data" id="formulario" class="border border-violeta rounded p-5 w-full flex justify-center items-center flex-col md:flex-row mx-auto flex-wrap max-w-xl mb-10">
            @csrf
            @method('PUT')
