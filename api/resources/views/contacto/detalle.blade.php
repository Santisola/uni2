...
@section('main')
    <div class="container-2xl mb-5 ">
        <h1 class="text-center texto-violeta font-bold text-3xl mb-5 capitalize">Asunto: {{ $contacto->asunto }}</h1>
        <div class="mx-auto rounded border max-w-4xl p-5">
            ...
            <h2 class="mt-5 text-2xl font-bold texto-violeta">Mensaje:</h2>
