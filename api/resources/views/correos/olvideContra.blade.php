                            ...
                            <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                <tr>
                                    <td align="center" valign="top" style="font-size: 18px">
                                        Nos llegó una solicitud para restablecer la contraseña. <br />
                                        A continuación te dejamos el código para poner en la aplicación y así poder seguir con el proceso. ¡Éxitos!
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                <tr>
                                    <td align="center" valign="middle" bgcolor="#5C3AE2" style="padding: 10px 0">
                                        <h2 style="margin: 0 10px; font-weight: bold; color: white">{{ $token }}</h2>
                                    </td>
                                </tr>
                            </table>
