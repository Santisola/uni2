...
export default function EditarPerfil() {
    ...
    return (
        ...
        >
            ...
            <h2 className={"mb-5 text-xl font-semibold"}>Cambie los datos que usted desee</h2>
            <p className={"mb-10 text-center"}>Elija que desea editar</p>
            <dl>
                <dt
                    ...
                    editarImagen ?
                        ...
                        (
                            <dd>
                                ...
                                <img src={process.env.API_IMAGEN + imagen} width={150} height={150} alt={"Imagen de perfil"}/>
                            </dd>
                        )
                }
                <hr className={"my-5"}/>
